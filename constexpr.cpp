...
int main(int argc, char* argv[]) {
    if (argc < 2) {
        std::cout << "Uasge: " << argv[0] << " number" << std::endl;
        return 1;
    }
    ...
    std::cout << "The factorial of " << input_number <<  " is " << output_number << std::endl;

    std::cout << "The factorial of -1 is " << regulation << std::endl;
